...
final class NativePlatform {
    ...
    private static String os(String osName) {
        ...
        throw new IllegalStateException("unsupported OS for a dengjen-tashkeel native library: " + osName);
    }
    ...
    private static String arch(String os, String osName, String osArch) {
        ...
        if (os.equals(WINDOWS)) {
            ...
            throw new IllegalStateException(
                    "unsupported Windows architecture for a dengjen-tashkeel native library: " + osArch);
        }
        if (os.equals("macos")) {
            if (isArm64) {
                return AARCH64;
            ...
            throw new IllegalStateException(
                    "unsupported macOS architecture for a dengjen-tashkeel native library: " + osArch);
        }
        if (isX64) {
            return "x86_64";
        }
        throw new IllegalStateException(
                "unsupported " + osName + " architecture for a dengjen-tashkeel native library: " + osArch);
    }
}
